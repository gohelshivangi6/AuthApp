  ...
  return (
    <Box display="flex" minHeight="90vh" alignItems="center" justifyContent="center">
      <GlassCard>
        ...
        {infoMessage && (
          <Alert severity="info" sx={{ mb: 3, background: 'rgba(99, 102, 241, 0.1)', color: '#a5b4fc', border: '1px solid rgba(99, 102, 241, 0.2)' }}>
            {infoMessage}
          </Alert>
        )}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Box display="flex" justifyContent="flex-end" mt={1}>
            <Link to="/forgot-password" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.85rem' }}>
              Forgot Password?
            </Link>
          </Box>
